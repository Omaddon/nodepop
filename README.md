...
* ***/lib***: 
	...
	* ***local_config.json***: aquí podemos encontrar configuración local relativa a: la cadena de conexión a la base de datos de mongodb, el ususario para test creado al iniciar y la duración del toque por defecto u omisión.
